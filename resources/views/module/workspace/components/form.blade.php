                    ...
                    <form  action="{{route('workspace.store')}}" method="post" >
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                            ...
                            <div class="sm:col-span-3">
                                <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Workspace Name</label>
                                <div class="mt-2">
                            ...
                            <div class="col-span-full">
                                <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Workspace Description</label>
                                <div class="mt-2">
                        ...
                        <div class="mt-6 flex items-center justify-end gap-x-6">
                            <a href="{{route('workspace.index')}}" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
